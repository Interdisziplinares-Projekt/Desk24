...
warpGlobals.i18n.phrases = {
    ...
    "Select user": "Wähle Benutzer",
    'Members of: %{group}': 'Mitglieder der Gruppe: %{group}',
    "Are you sure to remove %{user} from group %{group}?": "Möchtest du diesen Nutzer %{user} aus der Gruppe %{group} wirklich löschen?",
    ...
    "ARE YOU SURE TO DELETE USER: %{user}?": "Möchtest du diesen Nutzer löschen: %{user}?",
